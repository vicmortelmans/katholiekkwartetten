...
google_spreadsheet_key = "0Au659FdpCliwdE01N0NSQ2stUW9laVRjNElpS0lUTnc"
...
class MC(Spreadsheet_index):
    """Read the published google spreadsheet containing MC Q/A
    ...
    def update_fields(self, updates):
        Spreadsheet_index.update_fields(self, updates, 'n')

    def delete_rows(self, obsolete_rows):
        Spreadsheet_index.delete_rows(self, obsolete_rows, 'n')
